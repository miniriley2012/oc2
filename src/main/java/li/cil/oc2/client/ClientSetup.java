...
public final class ClientSetup {
    ...
    public static void handleModelRegistryEvent(final ModelEvent.RegisterGeometryLoaders event) {
        event.register(Blocks.BUS_CABLE.getId().getPath(), new BusCableModelLoader());
    }
    ...
    @SubscribeEvent
    public static void handleRegisterBlockColorHandlerEvent(final RegisterColorHandlersEvent.Block event) {
        event.register(new BusCableBlockColor(), Blocks.BUS_CABLE.get());
    }

    @SubscribeEvent
    public static void handleRegisterItemColorHandlerEvent(final RegisterColorHandlersEvent.Item event) {
